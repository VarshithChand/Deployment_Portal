...
// endpoints, is admin-gated via AdminGate (same bootstrap-aware rule as
// Settings/Access/etc. — see AdminGate/SettingsController). No class-level
// [Authorize]: it would sit in front of that check and block the
// intentional bootstrap flow it exists for.
[ApiController]
[Route("api/docker")]
