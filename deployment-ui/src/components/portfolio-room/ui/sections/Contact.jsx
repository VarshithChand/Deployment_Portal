...
// Buttons, not a <form> - mailto: is a plain link action.
export default function Contact() {
    ...
    return (
        ...
        <div className="proom-contact">

            <p>The fastest way to reach me is email.</p>

            <div className="proom-contact-actions">

                <button type="button" className="proom-btn proom-btn-primary" onClick={copyEmail}>
                    {copied ? <><Check size={14} /> Copied</> : <><Copy size={14} /> {CONTACT.email}</>}
                </button>

                <a href={`mailto:${CONTACT.email}`} className="proom-btn">
                    <Mail size={14} /> Email me
                </a>

            </div>

            <div className="proom-contact-socials">
