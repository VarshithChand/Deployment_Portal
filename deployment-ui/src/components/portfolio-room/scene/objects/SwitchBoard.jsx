...
// Sized up ~1.6x from the original pass along with everything else below
// (it was a near-invisible sliver on the wall before) - checked against
// its neighbors on the same back-wall stretch (Window at world x=3,
// Door's frame at world x~5.17-6.43): even at this size the switchboard
// only spans world x~4.2-4.6, comfortably clear of both.
const SWITCHES = [
    { name: "fan", label: "FAN", z: -0.128 },
    { name: "bedLight", label: "BED", z: 0 },
    { name: "cluster", label: "SKILLS", z: 0.128 }
];
...
export default function SwitchBoard({ position = [0, 0, 0], rotation = [0, 0, 0] }) {
    ...
    return (
        ...
        <group position={position} rotation={rotation}>
            ...
            {/* plate */}
            <mesh>
                <boxGeometry args={[0.032, 0.544, 0.384]} />
                ...
                return (
                    ...
                    <group key={name}>
                        ...
                        <mesh
                            ...
                            onPointerOut={(e) => { e.stopPropagation(); setHovered(null); document.body.style.cursor = "auto"; }}
                        >
                            <boxGeometry args={[0.048, 0.08, 0.024]} />
                        ...
                        <mesh position={[0.0176, -0.128, z]}>
                            <sphereGeometry args={[0.0128, 6, 6]} />
                        ...
                        {/* Text defaults to facing +z; the plate/switches
                            ...
                            wall instead. */}
                        <Text font={MONO_FONT} fontSize={0.032} color="#5b6b83" anchorX="center" anchorY="middle" rotation={[0, Math.PI / 2, 0]} position={[0.0176, -0.208, z]}>
                            {label}
                        </Text>
