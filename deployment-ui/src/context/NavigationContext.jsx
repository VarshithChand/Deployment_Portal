...
const TABS = ["dashboard", "deploy", "approvals", "pullRequests", "storage", "analytics", "timeline", "history", "environments", "templates", "cloudServices", "services", "paasHosting", "ecr", "acr", "artifactRegistry", "dockerHub", "ghcr", "gitlabRegistry", "jfrog", "harbor", "nexus", "docker", "codeQuality", "sonarcloud", "codeql", "eslint", "pylint", "checkstyle", "settings"];
