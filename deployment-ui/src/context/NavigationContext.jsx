...
const TABS = ["dashboard", "deploy", "approvals", "pullRequests", "storage", "analytics", "timeline", "history", "environments", "templates", "cloudServices", "services", "paasHosting", "containerRegistry", "docker", "codeQuality", "sonarcloud", "codeql", "eslint", "pylint", "checkstyle", "settings"];
