...
const TABS = ["dashboard", "deploy", "approvals", "pullRequests", "storage", "analytics", "timeline", "history", "environments", "templates", "azureDevOpsDashboard", "azureDevOpsBranches", "azureDevOpsPipelines", "azureDevOpsArtifacts", "azureDevOpsPullRequests", "azureDevOpsFeeds", "codeCommit", "gitlab", "bitbucket", "cloudServicesAws", "cloudServicesAzure", "cloudServicesGcp", "services", "paasHosting", "ecr", "acr", "artifactRegistry", "dockerHub", "ghcr", "gitlabRegistry", "jfrog", "harbor", "nexus", "docker", "codeQuality", "sonarcloud", "codeql", "eslint", "pylint", "checkstyle", "settings"];
